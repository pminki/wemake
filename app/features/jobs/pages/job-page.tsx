      ...
      <div className="grid grid-cols-6 -mt-20 gap-20 items-start">
        <div className="col-span-4 space-y-10">
          ...
          <div className="space-y-2.5">
            ...
            <p className="text-lg">
              This is a full-time remote position for a Software Enginner.
              We are looking for a skilled and experienced Software Engineer to
              join our team.
            </p>
          </div>
          <div className="space-y-2.5">
            <h4 className="text-2xl font-bold">Responsibilites</h4>
