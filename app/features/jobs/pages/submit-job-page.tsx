...
import SelectPair from "~/common/components/select-paire";
import { JOB_TYPES, LOCATION_TYPES, SALARY_RANGE } from "../constants";
import { Button } from "~/common/components/ui/button";

export const meta: Route.MetaFunction = () => {
  return [
    { title: "Post a Jos | wemake" },
    { 
      name: "description",
...
export default function SubmitJobPage() {
  return (
    <div>
      <Hero
        title="Post a Job"
        subtitle="Reach out to the best developers in the worlkd"
      />
      <Form className="max-w-screen-2xl flex flex-col items-center gap-10 mx-auto">
        ...
        <Button type="submit" className="w-full max-w-sm cursor-pointer" size="lg">
          Post job for $100
        </Button>
      </Form>
    </div>    
