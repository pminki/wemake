...
-- ALTER TABLE "follows" DROP CONSTRAINT "follows_follower_id_profiles_profile_id_fk";
-- --> statement-breakpoint
-- ALTER TABLE "follows" DROP CONSTRAINT "follows_following_id_profiles_profile_id_fk";
-- --> statement-breakpoint
